...
public final class SvTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(SvTestDirectories.class);

  private SvTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("servitor");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/servitor/tests/%s", name);
